...
insert into kakaobook (authors, title , contents, datetime, isbn, publisher, thumbnail, booknum, genre) 
values ('예리히 프롬', '노인과 바다', '노벨 문학상, 퓰리처상 수상 작가, 20세기 미국 문학을 개척한 작가 어니스트 헤밍웨이의 대표작.<노인과 바다>는 헤밍웨이의 마지막 소설로, 작가 고유의 소설 수법과 실존 철학이 짧은 분량 안에 집약되어 있다.', '2016-09-12', '9791187446019', '꿈결', '60.jpg', 60, '해외소설'); 
...
'1998-09-30', '9788985429092', '아우성 문고', '61.jpg', 61, '인문'); 
...
'2019-08-10', '9788935610242', '한길사', '62.jpg', 62, '해외소설'); 
...
'2016-05-19', '9788937475108', '민음사', '63.jpg', 63, '시'); 
...
'2012-04-20', '9788977757523', '철학과현실사', '64.jpg', 64, '사회과학'); 
...
'2019-09-01', '9788931011623', '문예출판사', '65.jpg', 65, '인문'); 
...
'2018-10-30', '9788932473901', '을유출판사', '68.jpg', 68, '사회과학'); 
...
인류가 자유에 내재해 있는 책임을 질 수 없다면 권위주의에 의지하게 될 것이다. 이것이 우리 시대의 가장 탁월한 사상가로 꼽히는 에리히 프롬의 대표작 『자유로부터의 도피』의 중심 사상이다. 이 책은 1941년에 출판되었을 때와 마찬가지로 지금도 시의적절하다. 개인을 고립시키고 무력한 존재로 만드는 근대적 자유의 특성, 권위주의 체제가 생겨나는 원인 등을 이토록 깊이 통찰한 책은 지금까지 없었다. 프롬은 이 책에서 정신분석의 통찰을 바탕으로, 자유로부터 도피하여 전체주의 지배에 기꺼이 복종하는 것으로 입증되는 근대 문명의 병폐를 분석한다.', '2020-09-02', '9788985429092', '휴머니스트', '69.jpg', 69, '사회과학'); 
