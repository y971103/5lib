...
insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('홍세화', '나는 빠리의 택시운전사', '1995년 "똘레랑스"라는 독특한 개념을 제시하면서, 우리 사회에 진지한 성찰을 요구한 이 책은, 짙게 남아 있는 억압적인 사회 분위기에서 살아가던 우리에게 상식적인 배려와 용인의 미덕을 진지하게 들려줬다. 그리고 가난했지만 행복한 빠리 시절의 망명기를 담담하고 솔직하게 고백함으로써 공감도 얻어냈다.', '1995-03-01', 9788936471187,'창작과비평사', '26.jpg', 26); 

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('히가시노', '비밀1', '데뷔 이후부터 큰 인기를 얻었지만 한계를 지적받고 번번이 문학상 수상의 문턱에서 미끄러졌던 작가는 정면 돌파를 선언하고 1년 넘게 원고 집필에만 몰두한다. 그 결과물이 바로 스스로 작가 인생의 전환점이라고 밝힌 이 책 『비밀』이다.', '2021-07-21', 9791138400428, '소미미디어', '27.jpg', 27); 

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('히가시노', '비밀2', ' 교통사고로 엄마는 죽고 딸이 기적적으로 살아나지만 놀랍게도 딸의 몸에는 엄마의 영혼이 자리잡고 있다. 이들을 아내와 딸로 둔 남자에게 그녀는 아내일까, 딸일까. 딸의 몸을 빌린 아내, 아내의 영혼이 깃든 딸과의 사랑을 팽팽한 긴장감 속에 펼쳐진다.', '2008-02-04', 9788979197846,'창해' ,'28.jpg', 28); 
...
insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('가스통 르루', '오페라의 유령', '[오페라의 유령]의 주인공은 언제나 오페라 극장 2층의 5번 박스석을 차지하는 괴신사다. 그는 천상의 목소리를 타고났지만 사람들 앞에 모습을 드러낼 수 없는 비운의 음악가이며, 천재적이고 악마적인 건축가이기도 하다. 오페라의 유령은 극장의 프리마돈나를 사랑하게 되어 그녀를 납치한다. 서양 문화권의 이야기 원형인 [미녀와 야수]류의 섬뜩하면서도 애절한 로맨틱 미스터리 소설.', '2003-11-05', 9788970752365,'문학세계사' ,'30.jpg', 30); 
...
insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('김훈', '칼의 노래', '한 국가의 운명을 단신의 몸으로 보전한 당대의 영웅이자, 정치 모략에 희생되어 장렬히 전사한 명장 이순신. 저자는 당대의 사건들 속에서 이순신을 지극히 인간적인 존재로 표현해 내며, 사회 안에서 개인이 가질 수 있는 삶의 태도에 대해 이야기한다.', '2010-02-27', '8984980692', '생각의나무', '36.jpg', 36); 
...
insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('이효석', '메밀 꽃 필 무렵', '이 책은 이효석의 작품세계를 보다 쉽게 알 수 있도록 그의 작품 중 총 11편의 문제작을 선정, 수록하였다. 특히 그의 대표작 메밀꽃 필 무렵은 토속적이고 한국적인 색채가 강한 데다 작품성이 뛰어나 이효석을 일약 문단의 기린아로 자리매김하게 했다.', '2014-08-15', '9791185742212', '에세이퍼블리싱', '40.jpg', 40);
...
insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('펄 벅', '대지', '왕룽과 그의 아내 오란, 그리고 그들로부터 비롯되는 한 가족의 역사는 어느 왕조의 이야기 못잖게 파란만장한 삶과 죽음, 사랑, 질병, 전쟁, 혁명, 질투의 서사시를 엮어낸다.', '2003-05-01', '9788931004151', '문예출판사', '58.jpg', 58); 

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('톨스토이', '부활', '한때 카추샤를 능욕, 그녀를 윤락의 길에 몰아 넣었던 네프류도프 공작이 살인 혐의를 받고 법정에 서게 된 그녀와 배심으로서 재회한다. 그는 죄의식에 번민한 끝에 카추샤의 갱생을 통해 속죄를 하고 자신의 허위에 찬 생활을 근본적으로 바로잡으려 한다.', '2019-11-25', '9791165220501', '유페이퍼', '59.jpg', 59); 

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('예리히 프롬', '노인과 바다', '노벨 문학상, 퓰리처상 수상 작가, 20세기 미국 문학을 개척한 작가 어니스트 헤밍웨이의 대표작.<노인과 바다>는 헤밍웨이의 마지막 소설로, 작가 고유의 소설 수법과 실존 철학이 짧은 분량 안에 집약되어 있다.', '2016-09-12', '9791187446019', '꿈결', '60.jpg', 60);

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('구성애', '구성애의 성교육', '은밀한 것, 숨겨야 하는 것이라고 여겼던 성에 대해 당당하게 말하는 "성교육 전도사" 구성애의 진솔한 이야기들이 함께 담겨있다. 우리가 성에 대해 알고 있었던 것들, 그 중에 잘못 생각하고 있었던 것들에 대해 일깨워 주는 목소리가 힘차다.', 
'1998-09-30', '9788985429092', '아우성 문고', '61.jpg', 61); 

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('시오노 나나미', '로마인 이야기 1', '로마 제국의 1천년 역사를 새롭게 조명한 일본 여류 작가의 저서. <로마는 하루아침에 이루어지지 않았다> 편. 로마 역사를 독특한 역사관으로 해석하는 저자는 로마인들이 특유의 개방성으로 주변의 모든 문화를 포용해 대제국을 건설하였음을 주장하고 있다.', 
'2019-08-10', '9788935610242', '한길사', '62.jpg', 62); 
...
'2016-05-19', '9788937475108', '민음사', '63.jpg', 63); 

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('김광수', '비판적 사고론', '한신대학교 철학과 교수로 퇴임한 김광수의 『비판적 사고론』. 40대 이후부터 본질적으로는 실용적인 비판적 사고와 함께한 저자의 삶의 흔적을 뜨거운 열정과 함께 되살리고 있다. 비판적 사고의 예도 확인하게 된다. 비판적 사고에 대해 알고 싶어하는 사람들에게 도움을 건네고 있다.', 
'2012-04-20', '9788977757523', '철학과현실사', '64.jpg', 64); 

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('에리히 프롬', '사랑의 기술', '에리히 프롬의 마지막을 함께한 라이너 풍크 박사의 《사랑의 기술》 50주년 기념판에 부치는 글 수록
...
'2019-09-01', '9788931011623', '문예출판사', '65.jpg', 65); 

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values (' 아가사 크리스티', '그리고 아무도 없었다', '전 세계 미스터리의 역사를 재창조한 추리 소설의 여왕,
...
'2014-11-25', '9788960177758', '황금가지', '66.jpg', 66); 

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('존 밀턴', '실락원', '영국의 대표적인 시인이자 사상가의 대서사시. 구약성서의 <창세기>에 근거한 아담과 하와의 타락과 낙원 추방을 묘사하여 인간의 원죄를 주제로 하였다', 
'1994-05-01', '9788936603373', '일신서적출판시', '67.jpg', 67);

insert into kakaobook (authors, title, contents, datetime, isbn, publisher, thumbnail, booknum) 
values ('리처드 도킨스', '이기적 유전자', '과학을 넘어선 우리 시대의 고전, 『이기적 유전자』 40주년 기념판
...
'2018-10-30', '9788932473901', '을유출판사', '68.jpg', 68); 
...
'2020-09-02', '9788985429092', '휴머니스트', '69.jpg', 69); 
...
'2020-10-30', '9788932920498', '열린책들', '70.jpg', 70);   
