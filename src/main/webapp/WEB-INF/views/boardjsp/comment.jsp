    ...
    <body>
      ...
      <header class="main_menu">
        ...
        <body class="is-preload">
         ...
         <!-- Nav -->
         <nav id="nav">
               <a href="Shelf.html" class="icon solid fa-book-open"><span>Shelf</span></a>
               <a href="Habit.html" class="icon solid fa-chart-bar"><span>Habit</span></a>
               <a href="comment.html" class="icon solid fa-bookmark active3"><span>Comment</span></a>            
         </nav>
            <!--main css-->
            <div id="main">
                <!-- Comment 감상공유 -->
